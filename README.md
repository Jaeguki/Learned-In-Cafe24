...
(Full GC란 Old Generation을 GC하는 것으로, 각 GC 별 알고리즘에 따라서 처리 과정중에 Stop The World를 발생하므로 추천하지 않습니다.)
...
~~~
Java 스택 내의 지역 변수, 연산자 스택에 객체의 참조 정보가 있는 Object. 즉 자바 메서드 실행시 사용하는 지역 변수와 파라미터들에 의한 참조 정보가 있는 Object

메서드 영역의 Constant Pool에 있는 Refernece 정보를, Constant Pool을 통해 간접 연결을 하고 있는 Object.

JNI(Java Native Interfate)를 통해 생성된 객체
~~~
